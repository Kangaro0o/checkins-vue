...
<script>
  ...
  export default {
    ...
    beforeRouteEnter(to, from, next) {
      ...
      let activeElement, curEmailIndex, screenCenter, svgCoords, emailCoords, emailScrollMax, chinMin = .5, dFromC,
        mouthStatus = 'small', blinking, eyeScale = 1, eyesCovered = false, showPasswordClicked = false;
      let eyeLCoords, eyeRCoords, noseCoords, mouthCoords, eyeLAngle, eyeLX, eyeLY, eyeRAngle, eyeRX, eyeRY, noseAngle,
